...
由于有些插件之间有依赖关系所以没全部列出来，如过有我问题可以对比我的截图。<img src='https://github.com/mabeijianxi/android-automation/blob/master/image/image_4.png'/><img src='https://github.com/mabeijianxi/android-automation/blob/master/image/image_5.png'/><img src='https://github.com/mabeijianxi/android-automation/blob/master/image/image_6.png'/><img src='https://github.com/mabeijianxi/android-automation/blob/master/image/image_7.png' />。<br/>
...
配置好JDK与Gradle。由于我本地已安装好JDK与Gradle所以只需为其指定路径即可。<br/><img src='https://github.com/mabeijianxi/android-automation/blob/master/image/image_9.png'/><img src='https://github.com/mabeijianxi/android-automation/blob/master/image/image_10.png' /><br/>
...
<h4>四、打包喝咖啡</h4>
到这里那么最感动的时刻来了，轻轻的点击下保存按钮，这时候你会来到构建界面，轻击 Build with Parameters，就会出现这个界面<br/><img src='https://github.com/mabeijianxi/android-automation/blob/master/image/image_27.png'/><br/>配置好参数，按下时代性的构建。从这一刻起谁向你要包你可以点根烟淡淡的说道:妈的，撸着呢，一边自己打去。我反正是受够了要包岁月。
<h4>注意事项：</h4>
1、参数传递的时候Jenkins里面的参数名称需要与build.gradle里面的一致，不然没什么卵用。如:<br/><img src='https://github.com/mabeijianxi/android-automation/blob/master/image/image_28.png' /><img src='https://github.com/mabeijianxi/android-automation/blob/master/image/image_29.png' /><br/>
